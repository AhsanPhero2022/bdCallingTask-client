...
import doller from "../../../assets/images/Dollar Minimalistic.png";
import { FaChevronDown } from "react-icons/fa";

const PropertySearch = () => {
  return (
    <div className="relative z-10 p-8 shadow-2xl rounded-[8px] mx-auto w-[90%] max-w-[990px] bg-white mt-[-250px]">
      {/* Menu */}
